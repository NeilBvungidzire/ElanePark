        ...
        <SafeAreaView style={styles.container}>
            <ScrollView contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.infoContainer}>
                    ...
                    Smart Parking Mobile Application makes finding and paying for parking easy. Explore nearby parking spots, reserve in advance, and earn loyalty points with every use!
                    </Text>
                </View>
            </ScrollView>
